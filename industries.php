   ...
   <div class="container">
      <div class="row">
         <div class="col-md-6 col-lg-3 d-flex services align-self-stretch px-4 ftco-animate">
            <a href="finance.php" class="d-block text-dark">
         ...
         <div class="col-md-6 col-lg-3 d-flex services align-self-stretch px-4 ftco-animate">
            <a href="#" class="d-block text-dark">
               ...
               <div class="media-body">
                  <h3 class="heading">GOVERNMENT, NGOS & EDUCATION (GNE)</h3>
                  <p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic.</p>
               </div>
            </a>
         </div>
         <div class="col-md-6 col-lg-3 d-flex services align-self-stretch px-4 ftco-animate">
            <a href="#" class="d-block text-dark">
               ...
               <div class="media-body">
                  <h3 class="heading">INDUSTRIAL & CONSUMER MARKETS (ICM)</h3>
                  <p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic.</p>
               </div>
            </a>
         </div>
         <div class="col-md-6 col-lg-3 d-flex services align-self-stretch px-4 ftco-animate">
            <a href="#" class="d-block text-dark">
               ...
               <div class="media-body">
                  <h3 class="heading">POWER & NATURAL RESOURCES</h3>
                  <p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic.</p>
               </div>
            </a>
         </div>
         ...
         <div class="col-md-6 col-lg-3 d-flex services align-self-stretch px-4 ftco-animate">
            <a href="#" class="d-block text-dark">
               ...
               <div class="media-body">
                  <h3 class="heading">REAL ESTATE & INFRASTRUCTURE (REI)</h3>
                  <p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic.</p>
               </div>
            </a>
         </div>
         ...
         <div class="col-md-6 col-lg-3 d-flex services align-self-stretch px-4 ftco-animate">
            <a href="tt.php" class="d-block text-dark">
               <div class="icon d-flex mr-2">
                  <span class="flaticon-budget"></span>
               </div>
               <div class="media-body">
                  <h3 class="heading">TECHNOLOGY & TELECOMMUNICATION (TT)</h3>
                  <p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic.</p>
               </div>
            </a>
         </div>
